...
> macOS 菜单栏里的 AI Token 余额仪表盘，先照顾 Kimi Code / Zhipu Coding / MiniMax / Volcengine Ark 这类有滚动额度的 Coding 套餐。
...
- 上游网页和内部接口可能变化，Kimi/Zhipu/DeepSeek/MiniMax/Volcengine Ark 适配器属于 best effort，失效时欢迎提 issue 或 PR。
